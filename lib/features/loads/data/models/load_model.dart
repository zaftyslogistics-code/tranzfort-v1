...
class LoadModel with _$LoadModel {
  const factory LoadModel({
    ...
    @JsonKey(name: 'is_super_load') @Default(false) bool isSuperLoad,
    ...
    @JsonKey(name: 'advance_required') @Default(true) bool advanceRequired,
    @JsonKey(name: 'advance_percent') @Default(70) int advancePercent,
