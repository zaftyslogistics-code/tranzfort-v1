...
class LoadsRepositoryImpl implements LoadsRepository {
  ...
  Load _modelToEntity(loadModel) {
    return Load(
      ...
      ratePerTon: loadModel.ratePerTon,
      advanceRequired: loadModel.advanceRequired,
      advancePercent: loadModel.advancePercent,
      chatCount: loadModel.chatCount,
